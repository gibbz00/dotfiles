{ ... }: {
  # TEMP: until YR/YE root certificats are part of the CA bundle
  # See https://community.letsencrypt.org/t/generation-y-root-program-inclusion/246108/5
  security.pki.certificates = [
    # From: https://letsencrypt.org/certs/gen-y/root-ye.pem
    ''
         -----BEGIN CERTIFICATE-----
      ...
      -----END CERTIFICATE-----
    ''
    # From: https://letsencrypt.org/certs/gen-y/root-yr.pem
    ''
      -----BEGIN CERTIFICATE-----
